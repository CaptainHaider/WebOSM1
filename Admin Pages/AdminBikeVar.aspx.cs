...
public partial class AdminBikeVar : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        SqlCommand insert = new SqlCommand("insert into Two_Wheelers(BRegistration_No,Registration_Date,Tax_Payment,Engine_No,Owner_Name,Class_Of_Vehicle,Horse_Power,Make,Body_Type,Model_Year,Safe_Custody,CPLC,Seating_Capacity,Remarks) values(@BRegistration_No, @Registration_Date,@Tax_Payment,@Engine_No,@Owner_Name,@Class_Of_Vehicle,@Horse_Power,@Make,@Body_Type,@Model_Year,@Safe_Custody,@CPLC,@Seating_Capacity,@Remarks)", cs);
        insert.Parameters.AddWithValue("@BRegistration_No", TextBox1.Text);
